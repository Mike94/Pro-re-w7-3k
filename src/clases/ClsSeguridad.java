 ...
 * @author MK
 * @fecha: 04-june-2012
 * @descripcion: Se trata de una clase de implementara encriptacion como MD5, SSL y otros...
 */
public class ClsSeguridad {
    /** Algoritmos de Encriptacion:
     * ----------------------------------------
     * SE TIENE QUE TENER ENCUENTA LA LONGITUD DE LA CADENA QUE GUARDARA EL STRING ENCRIPTADO
     * -Para el Proyecto de SCAB, se considera "uPassword" de una longitud de "VARCHAR(64)"
     * -Con lo mencionado anteriormente, no funcionaria para SHA-384 y SHA-512, pues estos
     ...
     * @autor MK
     * @function encriptar
     * @param textoParaEncriptar texto de entrada a la funcion para ser encriptada
     * @param metodoEncriptacion Se señalara el metodo de encriptacion que pueden ser:
